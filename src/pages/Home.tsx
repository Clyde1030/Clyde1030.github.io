          ...
          maxHeight: '90%'
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center px-8">
                ...
                <p className="text-xl md:text-2xl text-white/90 mt-2 drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">  A passionate data detective who loves building data pipelines, turning data to clear action by ML, and visualizations.</p>
                <Link to="/about">
