          ...
          maxHeight: '90%'
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center px-8">
                ...
                <p className="text-xl md:text-2xl text-white/90 mt-2 drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] my-[20px]"> I love transforming data! My work involves building data pipelines, creating effective models, and visualizing outcomes for clear action.</p>
                <Link to="/about">
